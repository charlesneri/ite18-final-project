...
<body>
  <div class="container">
    <div class="logo">
      <img src="{{ asset('logo123.png') }}" alt="logo">
    </div>
    <!-- Forms -->
    <div class="login-form">
      <form action="{{ route('login.process') }}" method="POST" id="loginsite">
        ...
        <div class="radio">
          <label>
            <input id="admin" type="radio" name="user" value="admin" checked />Admin
          </label>
          <label>
            <input id="casher" type="radio" name="user" value="casher" />Cashier
          </label>
        </div>
        <div class="buttons">
          <input type="submit" class="border-primary-subtle" value="Log-in" />
          <a href="{{ route('register.form') }}">
            <input type="button" class="border-primary-subtle" value="Create Admin Account" />
          </a>
        </div>
      </form>
    </div>
