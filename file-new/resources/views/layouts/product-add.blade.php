...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('cssfile/prod.css') }}" />
    <link
      rel="stylesheet"
    ...
    <div class="container-fluid main">
      <header class="position-sticky">
        <div class="position-sticky">
          ...
          >
            <i class="search-icon fa-solid fa-magnifying-glass w-5"></i>
            <input
              type="search"
              placeholder="Search...."
              name="search"
          ...
          <div class="plus-prod float-end me- pe-5">
            <button type="button" id="addProductBtn">
              <a href="#" class="lahi"
                ><i class="fa-solid fa-plus"></i
                ><span class="add ms-2">Add Product</span></a
              >
            </button>
            <button type="button">
              <a href="#" class="lahi"
                ><i class="fa-solid fa-square-check"></i
                ><span class="add ms-2">Select</span></a
              >
            </button>
          </div>
        </div>
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th class="items">Current Stock</th>
                    <th class="items">Category</th>
                  </tr>
                  <tr class="item-display"></tr>
                  <tr class="item-display"></tr>
                  <tr class="item-display"></tr>
                </thead>
              </table>
